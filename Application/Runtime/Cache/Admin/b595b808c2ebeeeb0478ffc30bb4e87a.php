...
<head>
	...
	<link rel="icon" href="/quantification2.0/Public/favicon.ico">
	<link rel="stylesheet" href="/quantification2.0/Public/layui/css/layui.css" media="all" />
	<link rel="stylesheet" href="/quantification2.0/Public/css/index.css" media="all" />
</head>
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-footer footer">
			<p><span>copyright @2018 千行软件工作室</span>　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-sm">捐赠作者</a></p>
		</div>
	</div>
	...
	<script type="text/javascript" src="/quantification2.0/Public/layui/layui.js"></script>

	<script>
		var $,tab,dataStr,layer;
			layui.config({
				base : "/quantification2.0/Public/js/"
			}).extend({
				"bodyTab" : "bodyTab"
			})
			layui.use(['bodyTab','form','element','layer','jquery'],function(){
				var form = layui.form,
					...
					tab = layui.bodyTab({
						...
						url : "/quantification2.0/Public/json/navs.json" //获取菜单json地址
					});
	...
	<script type="text/javascript" src="/quantification2.0/Public/js/index.js"></script>
	<script type="text/javascript" src="/quantification2.0/Public/js/cache.js"></script>
</body>
</html>